...
export const Card = ({ post }) => {
    ...
    const { data : user } = useAxios(`${Constants().USER_URL}/${post.userId}`)

    return(
        <>
          <div className="w-[850px] h-max justify-center flex-col p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <div className="items-center mb-5 text-gray-500">
